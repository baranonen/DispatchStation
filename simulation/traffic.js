...
function startSimulation() {
    ...
    startTime()
    addTrainToMap("KR549", "b181", "right")
    addTrainToMap("HL522", "b195", "right")
    addTrainToMap("HY521", "b186", "left")
    addTrainToMap("KR551", "b216", "right")
    addTrainToMap("KY560", "b206", "left")
    addTrainToMap("HY512", "b212", "left")
    addTrainToMap("HL516", "b222", "right")
    addTrainToMap("KR542", "b236", "right")
    addTrainToMap("KY514", "b231", "left")
    addTrainToMap("HL509", "b241", "right")
    addTrainToMap("HY550", "b233", "left")
    addTrainToMap("KY519", "b13", "left")
    addTrainToMap("KR505", "b31", "right")
    addTrainToMap("HY538", "b9", "left")
    addTrainToMap("HL541", "b22", "right")
    addTrainToMap("HY532", "b65", "left")
    addTrainToMap("HL540", "b75", "right")
    addTrainToMap("HY553", "b138", "left")
    addTrainToMap("HL545", "b165", "right")
    addTrainToMap("HY557", "b164", "left")
    addTrainToMap("KY558", "b112", "left")
    addTrainToMap("KR536", "b121", "right")
    addTrainToMap("KY570", "b119", "left")
