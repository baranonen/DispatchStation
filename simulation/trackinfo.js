...
var blocks = {
    ...
    "b45": {"left": "b44", "right": "b46", "status": "unset", "direction": "", "isStation": false, "leftsignal": "s158", "rightsignal": "s303", "isOverlapBlock": false},
    ...
    "b9": {"left": "b8", "right": "b56", "status": "unset", "direction": "", "isStation": false, "leftsignal": "s208", "rightsignal": "s205", "isOverlapBlock": false},
...
var points = {
    "p421": {"normalleft": "b32", "divergingleft": "b32", "normalright": "b33", "divergingright": "b40", "position": "normal", "status": "unset", "systemlock": false, "direction": "left"},
    "p502": {"normalleft": "b26", "divergingleft": "b33", "normalright": "b27", "divergingright": "b27", "position": "normal", "status": "unset", "systemlock": false, "direction": "left"},
    "p427": {"normalleft": "b40", "divergingleft": "b40", "normalright": "b41", "divergingright": "b43", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p422"},
    "p428": {"normalleft": "b41", "divergingleft": "b42", "normalright": "b44", "divergingright": "b44", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p429"},
    "p503": {"normalleft": "b4", "divergingleft": "b4", "normalright": "b5", "divergingright": "b54", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p506"},
    "p504": {"normalleft": "b5", "divergingleft": "b55", "normalright": "b6", "divergingright": "b6", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p505"},
    "p417": {"normalleft": "b29", "divergingleft": "b29", "normalright": "b30", "divergingright": "b30", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p418"},
    "p418": {"normalleft": "b11", "divergingleft": "b24", "normalright": "b12", "divergingright": "b12", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p417"},
    "p423": {"normalleft": "b14", "divergingleft": "b14", "normalright": "b15", "divergingright": "b25", "position": "normal", "status": "unset", "systemlock": false, "direction": "left"},
    "p501": {"normalleft": "b15", "divergingleft": "b15", "normalright": "b16", "divergingright": "b26", "position": "normal", "status": "unset", "systemlock": false, "direction": "left"},
    "p505": {"normalleft": "b16", "divergingleft": "b16", "normalright": "b17", "divergingright": "b55", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p504"},
    "p506": {"normalleft": "b17", "divergingleft": "b54", "normalright": "b18", "divergingright": "b18", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p503"},
    "p425": {"normalleft": "b50", "divergingleft": "b50", "normalright": "b35", "divergingright": "b34", "position": "normal", "status": "unset", "systemlock": false, "direction": "left"},
    "p429": {"normalleft": "b35", "divergingleft": "b35", "normalright": "b36", "divergingright": "b42", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p428"},
    "p422": {"normalleft": "b36", "divergingleft": "b43", "normalright": "b37", "divergingright": "b37", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p427"},
    "p419": {"normalleft": "b1", "divergingleft": "b1", "normalright": "b2", "divergingright": "b11", "position": "diverging", "status": "unset", "systemlock": false, "direction": "left"},
    "p507": {"normalleft": "b23", "divergingleft": "b23", "normalright": "b58", "divergingright": "b52", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p508"},
    "p508": {"normalleft": "b56", "divergingleft": "b52", "normalright": "b57", "divergingright": "b57", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p507"},
    "p509": {"normalleft": "b57", "divergingleft": "b57", "normalright": "b10", "divergingright": "b53", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p510"},
    "p510": {"normalleft": "b58", "divergingleft": "b53", "normalright": "b59", "divergingright": "b59", "position": "normal", "status": "unset", "systemlock": false, "direction": "left", "flankprotection": "p509"},
}
...
var routes = {
    ...
    "208-206": { "blocks": ["b8"], "direction": "left", "status": false },
    "208-202": { "blocks": ["b8", "b7"], "direction": "left", "status": false },
    "208-156": { "blocks": ["b8", "b7", "b6", "p504n", "b5", "p503n", "b4", "b3"], "direction": "left", "status": false },
    "208-154": { "blocks": ["b8", "b7", "b6", "p504d", "b55", "b1001", "p505d", "b16", "p501n", "b15", "p423n", "b14", "b13"], "direction": "left", "status": false },
    ...
    "158-152": { "blocks": ["b44", "p428n", "b41", "p427n", "b40", "p421d", "b32", "b31"], "direction": "left", "status": false },
    "158-154": { "blocks": ["b44", "p428d", "b42", "b1002", "p429d", "b35", "p425n", "b50", "b25", "b1003", "p423d", "b14", "b13"], "direction": "left", "status": false },
    "158-166": { "blocks": ["b44", "p428d", "b42", "b1002", "p429d", "b35", "p425n", "b50"], "direction": "left", "status": false },
...
var signals = {
    ...
    "s208": {"nextblock": "b8", "prevblock": "b9", "direction": "left", "possibleends": ["b8"], "control": "auto", "status": "", "isReserved": "no"},
    ...
    "s158": {"nextblock": "b44", "prevblock": "b45", "direction": "left", "possibleends": ["b31", "b13"], "control": "auto", "status": "", "isReserved": "no"},
